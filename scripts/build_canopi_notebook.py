...
CELLS = [
    ...
    code(
        ...
        "    # E3 multilingual @ same tau (HEADLINE)",
        "    if ml:",
        "        scored = {lang: (labs, model.score(txts)) for lang,(txts,labs) in ml.items()}",
        "        writer.write_seed(s, 'crosslingual', EV.crosslingual_at_tau(scored, tau, 'CANOPI'))",
